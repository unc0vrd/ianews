...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.22.0, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'internalnews1' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-bd14">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/InternalArchiveNewsIconV3.png",
            'default_url' => home_url('/')
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="600" data-image-height="600">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-1131-21',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-1131-22',
                    'submenu_item_class' => 'u-nav-item',
    ...
    <p class="u-text u-text-default u-text-1">Internal <span class="u-text-palette-1-base">News</span>
    </p>
  </div>
</header>
